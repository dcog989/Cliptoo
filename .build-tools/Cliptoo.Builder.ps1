...
try {
    :mainLoop while ($true) {
        ...
        Write-Host "2) Standard Release Package"
        Write-Host "3) Portable Release Package"
        Write-Host "4) Installer (Coming Soon!)"
        Write-Host "5) Full Release (Standard + Portable + Changelog)"
